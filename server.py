...
print("Access-Control-Allow-Origin: *")        # this is to avoid CORS
...
output = subprocess.getoutput("sudo "+cmd)     # the value store in var is parse into system command and it return output
print(output)
